...
namespace API.SignalR
{
    public class MessageHub : Hub
    {
        ...
        public MessageHub(IUnitOfWork unitOfWork, PresenceTracker presenceTracker, IHubContext<PresenceHub> presenceHub, IMapper mapper)
        {
        ...
        {
            var group = await _unitOfWork.MessageRepository.GetConnectionGroup(Context.ConnectionId);
